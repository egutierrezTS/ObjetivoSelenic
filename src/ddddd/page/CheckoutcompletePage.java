...
public class CheckoutcompletePage {
    ...
    private WebElement completeHeaderField;

    @FindBy(xpath = "/descendant::button[normalize-space(.)='Back Home']")
    private WebElement backHomeSubmit;
    ...
    public String getCompleteHeaderFieldText() {
        return waitFor(completeHeaderField).getText();
    }


    public void clickBackHomeSubmit() {
